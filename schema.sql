...
CREATE TABLE Npcs (id SERIAL PRIMARY KEY, name TEXT UNIQUE, describtion TEXT, location_id INTEGER REFERENCES Locations);
...
CREATE TABLE Npc_notes (id SERIAL PRIMARY KEY, note TEXT, user_id INTEGER REFERENCES Users, npc_id INTEGER REFERENCES Npcs);
